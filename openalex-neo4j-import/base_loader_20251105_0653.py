...
class BaseLoader:
    ...
    def __init__(self, script_name):
        ...
        # Configure driver with longer timeouts for large operations
        self.driver = GraphDatabase.driver(
            os.getenv('NEO4J_URI'),
            auth=(os.getenv('NEO4J_USER'), os.getenv('NEO4J_PASSWORD')),
            max_transaction_retry_time=30.0,  # 30 seconds for retries
            connection_timeout=30.0,  # 30 seconds for connection
            max_connection_lifetime=14410  # 4 hour max connection lifetime
        )
