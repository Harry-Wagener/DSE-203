...
class SchemaSetup(BaseLoader):
    ...
    def setup_schema(self):
        ...
        query = """
        // ============================================================================
        // CONSTRAINTS - Enforce uniqueness on IDs
        // ============================================================================
        ...
        // ============================================================================
        // INDEXES - Speed up lookups and queries
        // ============================================================================
        
        // Work indexes
        CREATE INDEX work_year IF NOT EXISTS 
        FOR (w:Work) ON (w.publication_year);
        
        CREATE INDEX work_type IF NOT EXISTS 
        FOR (w:Work) ON (w.type);
        
        CREATE INDEX work_cited_by IF NOT EXISTS 
        FOR (w:Work) ON (w.cited_by_count);
        ...
        CREATE INDEX author_works_count IF NOT EXISTS 
        FOR (a:Author) ON (a.works_count);
        ...
        FOR (i:Institution) ON (i.display_name);
        
        // Topic indexes
        CREATE INDEX topic_name IF NOT EXISTS 
        FOR (t:Topic) ON (t.display_name);
        
        CREATE INDEX topic_subfield IF NOT EXISTS 
        FOR (t:Topic) ON (t.subfield_id);
        ...
        CREATE INDEX source_publisher IF NOT EXISTS 
        FOR (s:Source) ON (s.publisher);
        
        // Wait for all indexes to be built
        CALL db.awaitIndexes(300);
        """
        
        self.run_query(query, "Creating constraints and indexes...")
