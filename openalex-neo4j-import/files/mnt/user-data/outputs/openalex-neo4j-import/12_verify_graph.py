...
class GraphVerifier(BaseLoader):
    ...
    def get_relationship_counts(self):
        ...
        MATCH ()-[r6:RELATED_TO]-() WITH authored, affiliated, tagged, published, cited, count(r6) as related
        RETURN authored, affiliated, tagged, published, cited, related
        """
        ...
        if records:
            ...
            total_rels = sum([counts['authored'], counts['affiliated'], counts['tagged'],
                            counts['published'], counts['cited'], counts['related']])
    ...
    def run(self):
        ...
        try:
            ...
            if success:
                ...
                print("  2. Run sample queries to explore")
